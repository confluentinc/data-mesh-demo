...
public class UseCasesController {
    ...
    @GetMapping
    public List<UseCase> getDataProducts() throws UnsupportedEncodingException {
        return List.of(
                getEnrichUseCase(),
                getFilterUseCase(),
                getAggregateUseCase());
